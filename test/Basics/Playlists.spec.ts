...
describe('Pruebas de la clase Playlist', () => {
  ...
  it('lista.showInfo(0)', () => {
    ...
    lista.addSong(god);
    lista.addSong(lost);
    expect(lista.showInfo(0)).to.be.equal(`MiLista\n  -Géneros: Rock,Pop\n  -Playlist original: Sí\n`+
    `  -Duración: 0h 14min\n  -Canciones:\n    God gave me everything\n    Lost Stars\n    Payphone\n    Satisfaction\n`);
  });
  it('lista.showInfo(1)', () => {
    lista.deleteSong(god);
    lista.addSong(god);
    expect(lista.showInfo(1)).to.be.equal(`MiLista\n  -Géneros: Pop,Rock\n  -Playlist original: Sí\n`+
    `  -Duración: 0h 14min\n  -Canciones:\n    Satisfaction\n    Payphone\n    Lost Stars\n    God gave me everything\n`);
  });
  it('lista.showInfo(2)', () => {
  ...
  it('lista.showInfo(8)', () => {
    expect(lista.showInfo(8)).to.be.equal(`MiLista\n  -Géneros: Pop,Rock\n  -Playlist original: Sí\n`+
    `  -Duración: 0h 14min\n  -Canciones:\n    Payphone\n    Lost Stars\n    Satisfaction\n    God gave me everything\n`);
  });
  it('lista.showInfo(9)', () => {
    lista.deleteSong(lost);
    lista.addSong(lost);
    expect(lista.showInfo(9)).to.be.equal(`MiLista\n  -Géneros: Pop,Rock\n  -Playlist original: Sí\n`+
    `  -Duración: 0h 14min\n  -Canciones:\n    Satisfaction\n    God gave me everything\n    Payphone\n    Lost Stars\n`);
  });
  it('lista.showInfo(10)', () => {
    lista.deleteSong(payphone);
    lista.addSong(payphone);
    expect(lista.showInfo(10)).to.be.equal(`MiLista\n  -Géneros: Rock,Pop\n  -Playlist original: Sí\n`+
    `  -Duración: 0h 14min\n  -Canciones:\n    Lost Stars\n    God gave me everything\n    Payphone\n    Satisfaction\n`);
  });
  it('lista.showInfo(11)', () => {
    lista.deleteSong(payphone);
    lista.addSong(payphone);
    expect(lista.showInfo(11)).to.be.equal(`MiLista\n  -Géneros: Pop,Rock\n  -Playlist original: Sí\n`+
    `  -Duración: 0h 14min\n  -Canciones:\n    Satisfaction\n    God gave me everything\n    Payphone\n    Lost Stars\n`);
  });
});